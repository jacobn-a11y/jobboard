...
| `job-state`           | Plain Text | Parsed state: "New York", "Illinois" (for filtering) |
...
| `industry`            | Plain Text | From CSV: "Architecture & Engineering" (for filtering) |
...
│   ├── industry-signals.json  # Description keywords per industry (for Adzuna fallback matching)
